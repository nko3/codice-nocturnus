...
~~~sh
git clone git@github.com:nko3/codice-nocturnus.git
~~~
...
~~~sh
npm install -g jitsu
jitsu login --username nko3-codice-nocturnus --password NO5ZEt6tXh6y+M1+
jitsu deploy
~~~
...
~~~html
<iframe src="http://nodeknockout.com/iframe/codice-nocturnus" frameborder=0 scrolling=no allowtransparency=true width=115 height=25>
</iframe>
~~~
...
[2]: https://github.com/organizations/nko3/teams/280794
[3]: https://github.com/nko3/codice-nocturnus
